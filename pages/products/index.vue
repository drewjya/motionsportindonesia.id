...
<template>
  <div class="relative">
    ...
    <div class="absolute h-full w-full top-0 bg-gradient-to-b from-zinc-300 to-neutral-800 opacity-[0.35] z-50"></div>
    <div class="text-white text-4xl font-normal capitalize absolute bottom-0 z-[99] px-10 pb-8"
  ...
  <div class="flex justify-between px-9 bg-gray-50 py-4 sticky">
    <div class="flex space-x-3">
      ...
      <UDropdown :items="items" :popper="{ placement: 'bottom-start' }">
        <UButton class="bg-zinc-300 text-black hover:text-white w-52 justify-between items-center" color="black"
          variant="solid" block trailing-icon="i-heroicons-chevron-down-20-solid">
          Aturkan Berdasarkan
        </UButton>
      </UDropdown>
    </div>
    <div class="flex space-x-3">
      ...
      <UDropdown :items="items" mode="hover" :popper="{ placement: 'bottom-start' }">
        <UButton block class="bg-zinc-300 text-black w-52 justify-between hover:text-white items-center" color="black"
          variant="solid" :trailing="true" icon="i-heroicons-chevron-down-20-solid">
          Filter</UButton>
      </UDropdown>
    </div>
  </div>
  <div class="m-12">
        ...
        <div v-for="(e, index2) in 4">
          <div v-if="datas[4 * index + index2] !== undefined" class="flex-1">
            <div class="relative transition-transform ease-in-out duration-300">
              <img src="https://avatars.githubusercontent.com/u/739984?v=4" alt="" />
            </div>
    ...
    <div class="w-[28rem] h-8 mt-12 mx-auto flex justify-between">
      <UButton variant="solid" color="black" class="w-28 justify-center text-white hover:bg-gray-500"
        icon="i-heroicons-backward">Prev</UButton>
      <UButton variant="solid" color="black" class="w-28 justify-center hover:bg-gray-500" icon="i-heroicons-forward">Next
      </UButton>
    </div>
  </div>
</template>
